...
def main(library_info_path, tensor_input_path, timepoints, isotope_clusters_output_path, gauss_params=(3,1)):
	# open library_info
...
if __name__=='__main__':
	...
	main(library_info_path=args.library_info_path, tensor_input_path=args.tensor_input_path, timepoints=args.timepoints, isotope_clusters_output_path=args.isotope_clusters_output_path, gauss_params=args.gauss_params)