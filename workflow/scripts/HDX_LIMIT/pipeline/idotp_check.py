...
def gen_tensors_factorize(library_info_df, undeut_tensor_path_list, timepoint_index=0, n_factors=15, factor_gauss_params=(3, 1)):
    ...
    Args:
        ...
        factor_gauss_params: gaussian paramters for factorization
    ...
    for num, undeut_tensor_path in enumerate(undeut_tensor_path_list):
        ...
        new_data_tensor.DataTensor.factorize(n_factors=n_factors,
                                          gauss_params=factor_gauss_params)
...
def main(library_info_path, undeut_tensor_path_list, output_path=None, return_flag=None, n_factors=15, factor_gauss_params=(3,1)):
    ...
    iso_clusters_list, data_tensor_list = gen_tensors_factorize(library_info_df=library_info,
                                                                ...
                                                                n_factors=n_factors,
                                                                factor_gauss_params=factor_gauss_params)

    idotp_list, integrated_mz_list = calc_dot_prod_for_isotope_clusters(sequence=my_seq,
                                                                        undeut_isotope_clusters=iso_clusters_list)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--factor_gauss_params", type=tuple, default=(3,1), help="parameters for smoothing rt and dt dimensions")
