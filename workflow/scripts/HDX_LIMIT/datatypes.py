...
class IsotopeCluster:
    ...
    def __init__(
        ...
        #)**0.5)
        self.baseline_integrated_mz_rmse, self.baseline_integrated_mz_com, self.baseline_integrated_std, self.baseline_integrated_mz_FWHM = params_from_gaussian_fit(self)
